...
static const char *Err_Strings[NBR_ERRORS] = {
	ERROR_MSSG_0,
	ERROR_MSSG_1,
	ERROR_MSSG_2,
	ERROR_MSSG_3,
...
/**********************  ERR_enter  ***********************************/
void ERR_enter(const char *source, int lineno, int errorid, const char *modificationString)
/*
...
*/
{
	const char	*currChar;	/* used for outputting string */
